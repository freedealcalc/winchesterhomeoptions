...
export default async function ClarkeCountyDivorcePage() {
  ...
  const config = {
    ...
    bodyContent: `
      ...
      <p>Virginia is an "equitable distribution" state, not a community-property state — governed by <a href="https://law.lis.virginia.gov/vacode/title20/chapter6/section20-107.3/" target="_blank" rel="noopener noreferrer">Va. Code &sect;&nbsp;20-107.3</a>. The court doesn't automatically split marital assets 50/50. It first classifies property as separate (owned before the marriage, or received as a gift or inheritance), marital (acquired during the marriage), or a mix of both — a farmhouse or acreage owned before the wedding but paid down with marital income afterward is a common "mixed" property example in Clarke County. Only the marital share is subject to division.</p>
      <p>From there, the statute gives the court broad authority: it can order the home transferred to one spouse, order a private sale between the parties, or order a public sale directed by the court — weighing eleven factors including each spouse's contributions, the marriage's length, and how the property was acquired. Most Clarke County couples never get anywhere near a judge deciding this — they negotiate a sale or buyout directly, which is faster, costs less, and keeps control of the outcome, and the timeline for a rural property, in their own hands.</p>
      <h2>Where a Clarke County Divorce Case Sits</h2>
      <p>Divorce decrees and equitable distribution orders for Clarke County residents are handled by the <strong>Clarke County Circuit Court</strong>, 102 N. Church St., Berryville, VA &middot; (540) 955-5188. If a sale needs to be reflected in a separation agreement or final decree, that's the court your attorneys will be filing with.</p>
