...
export default async function ClarkeCountyProbatePage() {
  ...
  const config = {
    ...
    bodyContent: `
      ...
      <p>Qualification, wills, and probate matters for Clarke County go through the <strong>Clarke County Circuit Court</strong>, 102 N. Church St., Berryville, VA &middot; (540) 955-5188. That's the office your attorney will be filing with to get the executor or administrator qualified.</p>
