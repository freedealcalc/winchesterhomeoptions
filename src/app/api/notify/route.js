...
export async function POST(request) {
  try {
    ...
    const emailBody = `
New Lead — Winchester Home Options
...
https://supabase.com/dashboard/project/wnsrjggvmntdrtnvrpft/editor
    ...
    const response = await fetch('https://api.sendgrid.com/v3/mail/send', {
      ...
      body: JSON.stringify({
        ...
        from: { email: 'dan@hssvirginia.com', name: 'Winchester Home Options' },
        subject: `[WINCHESTER] New Lead: ${lead.first_name} ${lead.last_name} — ${lead.situation}`,
